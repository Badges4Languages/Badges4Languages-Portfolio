...
function printResult(badge) {
  ...
  ?>
    var content = content+'<center><button onclick="sendBadgePortfolio'+"('"+badge+"', '<?php echo get_post_meta($post->ID,'_passport_language',true); ?>')"+'">Send this badge to yourself</button></center><br />';
  <?php
  }
  ?>
  return content;
